...
public class ModBlockEntities {
 public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
    ...
    public static final RegistryObject<BlockEntityType<BlackJackPlayerTableBlockEntity>> ONE_ARMED_BANDIT_BE =
            BLOCK_ENTITIES.register("one_armed_bandit_be", () ->
                    BlockEntityType.Builder.of(BlackJackPlayerTableBlockEntity::new,
                            ModBlocks.ONE_ARMED_BANDIT_BLOCK.get()).build(null));
